...
from .external_research import _load_accepted_inputs, build_pilot


def main() -> int:
    parser = argparse.ArgumentParser(description="Build the authorized YEE-47 external research pilot")
