...
`family_id`, `source`, `D`, `W`, `F`, `C`, `source_score_balanced`, `source_score_demand_first`, `source_score_whitespace_first`, `resource_count`, `demand_available_count`, `freshness_available_count`, `demand_percentile_p75`, `demand_percentile_p90`, `demand_percentile_ge90_share`, `demand_percentile_ge95_share`, `freshness_age_days_p50`, `freshness_le90_share`, `freshness_gt365_share`, `demand_concentration_top1_share`, `demand_concentration_hhi`.
...
- `voxel_monetization_score` is null without a Voxel row or known paid-state count; otherwise `50*I(paid_count>0) + 50*paid_share_known`. It uses only YEE-43 Voxel paid fields, never price/currency.
